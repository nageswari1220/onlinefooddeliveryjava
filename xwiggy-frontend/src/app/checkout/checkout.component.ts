...
export class CheckoutComponent implements OnInit {
  ...
  cardNumberVal: boolean | null = null;
  monthVal: boolean | null = null;
  yearVal: boolean | null = null;
  cvvVal: boolean | null = null;
  nameOnCardVal: boolean | null = null;
  ...
  validMonth(): void {
    this.monthVal = this.month !== null && this.month >= 1 && this.month <= 12;
  }

  validYear(): void {
    this.yearVal = this.year !== null && this.year >= 19 && this.year <= 99;
  }

  validCvv(): void {
    this.cvvVal = this.cvv !== null && this.cvv >= 100 && this.cvv <= 999;
  }
